 ...
 * @author ThangBui
 */
public class AtomicConstraint implements Serializable {
    ...
    public boolean equals(Object ac){
            ...
            return (this.op == ac1.getConstraintOperator() && this.subPath.equals(ac1.getSubPath()) && this.resPath.equals(ac1.getResPath()));
    }
